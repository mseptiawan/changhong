    ...
    public function summary(Request $request)
    {
        ...
        $summary = DB::table('spgms')
            ...
            ->select(
                ...
                DB::raw('FORMAT(COALESCE(SUM(CASE WHEN sales_transactions.bigsize = 1 THEN sales_transactions.total_amount ELSE 0 END), 0) / (targets.target_bigsize / 1000000) * 100, 0 ) as percent_bigsize')
            )
            ->groupBy(
                'spgms.name',
